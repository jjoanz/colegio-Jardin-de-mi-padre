...
const MODULOS = [
  ...
  { key: "oferta_academica", label: "Oferta académica (aulas, materias, años escolares)" },
  ...
  { key: "academico", label: "Planificación docente (crear y editar las propias)" },
  { key: "revision_planificaciones", label: "Revisión de planificaciones (coordinador/director)" },
